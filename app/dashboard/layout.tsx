    ...
    <div className="min-h-screen bg-palantir-dark-gray-1 relative">
      ...
      >
        <div className="bg-yellow-500 h-full">
          <div className="flex items-center justify-between p-6 border-b border-yellow-500">
            <Link href="/" className="flex items-center space-x-3">
                <Image
                  src="/compositeblack.png"   // nama file di folder public
                  alt="Logo"
                  width={150}
                  height={150}
...
>
  ...
  <span className="font-medium">{item.name}</span>
      ...
      <div className="lg:pl-64">
        <header className="relative z-40 bg-black border-b border-palantir-dark-gray-4 px-6 py-4">
